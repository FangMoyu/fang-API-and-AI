...
/** changeUserApi POST /api/user/change/api */
export async function changeUserApiUsingPost(options?: { [key: string]: any }) {
  return request<API.BaseResponseboolean>('/api/user/change/api', {
    method: 'POST',
    ...(options || {}),
  });
}
...
/** getUserAccess GET /api/user/get/access */
export async function getUserAccessUsingGet(options?: { [key: string]: any }) {
  return request<API.BaseResponseUserAccessVO>('/api/user/get/access', {
    method: 'GET',
    ...(options || {}),
  });
}
