declare namespace API {
  ...
  type BaseResponseListLoveStory = {
    code?: number;
    data?: LoveStory[];
    message?: string;
  };
  ...
  type BaseResponseLoveStory = {
    code?: number;
    data?: LoveStory;
    message?: string;
  };

  type BaseResponseLoveStoryVO = {
    code?: number;
    data?: LoveStoryVO;
    message?: string;
  };
  ...
  type BaseResponsePageLoveStory = {
    code?: number;
    data?: PageLoveStory;
    message?: string;
  };
  ...
  type getLoveStoryByIdUsingGETParams = {
    /** id */
    id?: number;
  };
  ...
  type invokeAiGenChartInterfaceUsingPOSTParams = {
    chartType?: string;
    goal?: string;
    name?: string;
    userId?: number;
  ...
  type invokeAiGenCopyWritingUsingPOSTParams = {
    /** userInput */
    userInput?: string;
  };
  ...
  type listLoveStoryByPageUsingGETParams = {
    content?: string;
    current?: number;
    id?: number;
    pageSize?: number;
  ...
  type listLoveStoryUsingGETParams = {
    content?: string;
    current?: number;
    id?: number;
    pageSize?: number;
  ...
  type listTopInterfaceInfoUsingGETParams = {
    /** limit */
    limit?: number;
  };
