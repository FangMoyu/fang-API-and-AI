...
import {listChartByPageUsingPost} from "@/services/fangai-backend/chartController";
import {listMyGenChartByPageUsingPost} from "@/services/fangapi-backend/listAiProductionController";
...
const MyChartPage: React.FC = () => {
  ...
  const loadData = async () => {
    ...
    setLoading(true);
    try {
      const res = await listMyGenChartByPageUsingPost(searchParams);
      if (res.data) {
